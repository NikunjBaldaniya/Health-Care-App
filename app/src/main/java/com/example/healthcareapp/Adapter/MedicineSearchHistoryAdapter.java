...
import com.example.healthcareapp.MedicineSearchResultActivity;
import com.example.healthcareapp.Model.HistoryModel;
import com.example.healthcareapp.R;

import java.util.List;

public class MedicineSearchHistoryAdapter extends RecyclerView.Adapter<MedicineSearchHistoryAdapter.ViewHolder> {
    Context context;
    List<HistoryModel> historyList;
    DatabaseHelper dbHelper;

    public MedicineSearchHistoryAdapter(Context context, List<HistoryModel> historyList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnDelete.setOnClickListener(v ->{
            ...
            dbHelper.deleteMedicineSearchHistory(id);
